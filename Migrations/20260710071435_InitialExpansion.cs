...
{
    /// <inheritdoc />
    public partial class InitialExpansion : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Give existing rows a unique ISBN based on their ID to avoid the duplicate constraint
            migrationBuilder.Sql("UPDATE `Books` SET `ISBN` = CONCAT('LEGACY-', `Id`) WHERE `ISBN` = '' OR `ISBN` IS NULL;");
